...
import { User, Service, ContactInfo, HeroContent, SeoPage, WhyChoose, CTA, SiteInfo, AboutPage, ContactPage, ServicesPage } from '../models';
...
async function setupDatabase() {
  try {
    ...
    await WhyChoose.findOneAndUpdate(
      {},
      {
    ...
    await ContactPage.findOneAndUpdate(
      {},
      {
        heroTitle: 'İletişim',
